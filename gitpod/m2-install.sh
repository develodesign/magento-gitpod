...
cd magento2 && rm composer.json && rm ../pub/get.php && rm .gitignore && rm composer.lock && cp -avr .* $GITPOD_REPO_ROOT;
cd $GITPOD_REPO_ROOT && rm -r -f magento2 && rm app/etc/config.php;
